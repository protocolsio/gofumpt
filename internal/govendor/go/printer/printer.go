...
func (p *printer) internalError(msg ...any) {
	if debug {
		...
		fmt.Println(msg...)
		panic("github.com/protocolsio/protocols-gofumpt/internal/govendor/go/printer")
	}
}
	...
	if pos.IsValid() && (p.out.Line != pos.Line || p.out.Filename != pos.Filename) {
		if strings.ContainsAny(pos.Filename, "\r\n") {
			if p.sourcePosErr == nil {
				p.sourcePosErr = fmt.Errorf("github.com/protocolsio/protocols-gofumpt/internal/govendor/go/printer: source filename contains unexpected newline character: %q", pos.Filename)
			}
			return
		}
...
func (p *printer) print(args ...any) {
	for _, arg := range args {
		...
		default:
			...
			panic("github.com/protocolsio/protocols-gofumpt/internal/govendor/go/printer type")
		}
		// data != ""
...
unsupported:
	return fmt.Errorf("github.com/protocolsio/protocols-gofumpt/internal/govendor/go/printer: unsupported node type %T", node)
}
...
// the evolving needs of github.com/protocolsio/protocols-gofumpt/internal/govendor/go/format and cmd/gofmt without breaking
...
const (
	...
	//
	// This value is known in and used by github.com/protocolsio/protocols-gofumpt/internal/govendor/go/format and cmd/gofmt.
...
// use format.Node (package github.com/protocolsio/protocols-gofumpt/internal/govendor/go/format) for output that matches gofmt.
